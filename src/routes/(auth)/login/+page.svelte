...
<header class="mb-7 text-center">
	<h1 class="display text-3xl font-semibold">Willkommen <span class="text-gradient-primary">zurück</span></h1>
...
<form method="POST" use:enhance={() => {
	...
	{#if form?.error}
		<div class="rounded-lg border border-error/30 bg-error/10 px-3 py-2 text-error text-sm">
			{form.error}
		</div>
	{/if}
