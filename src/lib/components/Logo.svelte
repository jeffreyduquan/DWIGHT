...
<script lang="ts">
	...
	let { size = 32, showWordmark = false }: Props = $props();
</script>

<div class="inline-flex items-center gap-2" style:height="{size}px">
	<svg
		viewBox="0 0 32 32"
		width={size}
		height={size}
	...
	{#if showWordmark}
		<span class="wordmark text-base-content text-xl">DWIGHT</span>
	{/if}
</div>
